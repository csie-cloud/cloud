mod 'creator',
    :git => 'https://github.com/csie-cloud/creator.git',
    :ref => 'production'
mod 'controller_node',
...
mod 'razorsedge/network', '3.6.0'
# Dependency of razorsedge/network
...
# modules for Lavaburn/razor
mod 'razor',
    :git => "https://github.com/Lavaburn/puppet-razor.git",
    :ref => 'master'
